...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function c ()
    {
        ...
        if (!window.cPlaygroundUrl) {
            return;
        }

        var programRegexp = new RegExp('^ *\/\/ *program: *([A-Za-z-]+)');
        ...
        Array.prototype.forEach.call(elements, function(el) {
            el.onmouseover = function(e) {
                ...
                let program = code.match (programRegexp);
                console.log (program);
                ...
                if (program != null)
                {
                    ...
                    a.setAttribute('href', window.cPlaygroundUrl + '?p=' + program[1]);
    ...
    function rust ()
    {
        ...
        Array.prototype.forEach.call(elements, function(el) {
            el.onmouseover = function(e) {
                ...
                a.setAttribute('href', window.playgroundUrl + '?edition=2018&code=' +
